...
%March 13th, 2003
function objective=quartercar3b     %altered from Jacob's original file - hard coded the rest of the parameters
		...
		%inserted  Input Parameters 
			...
			Fr=0.1000;        	    %Size of the step function, Units are meters
...
%II. Simulation
	...
	%1. Mass Module
		Ms=Mt+((L*pi*(dao^2-(dao-2*ta)^2)/4)+(bs*Ls*hs))*rho; 
