;; Time-stamp: <2016-05-04 16:31:54 Miller(on Nsk1200019714M)>
...
(setq *asdf-dirs* '("~/DOME/models/stdio/"
                    ...
                    "~/DOME/models/stdio/reaction-time/"
                    ))
...
(setq *dump-image-name* "reaction-time")
(setq *install-directory* "~/DOME/models/stdio/reaction-time/")
