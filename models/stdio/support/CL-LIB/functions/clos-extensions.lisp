(in-package cl-lib)
(version-reporter "CL-LIB-FNS-CLOS" 5 2 ";; Time-stamp: <2008-05-03 13:33:44 gorbag>" 
                  "CVS: $Id: clos-extensions.lisp,v 1.2 2008/05/03 17:42:00 gorbag Exp $
make generate-inherited-slot-definer and generate-inherited-slot-writer more flexible
...
(defparameter *load-form-quote-p-fn* #'sample-load-form-quote-p-fn) ; can be elaborated upon by the user, e.g., if it 
