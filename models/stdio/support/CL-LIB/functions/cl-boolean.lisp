...
(IN-PACKAGE CL-LIB)
(version-reporter "CL-LIB-FNS-Boolean Fns" 5 0 ";; Time-stamp: <2008-05-03 13:30:19 gorbag>" 
                  "CVS: $Id: cl-boolean.lisp,v 1.2 2008/05/03 17:41:59 gorbag Exp $
...
(defmacro nand (&rest predicates)
  "True only if all predicates are not true. Short circutes when it
finds one is false."
