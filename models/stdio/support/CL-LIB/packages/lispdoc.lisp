...
(cl-lib-essentials:version-reporter "LispDoc" 1 8 
                                    ";; Time-stamp: <2007-11-22 22:47:00 gorbag>"
                                    "CVS: $Id: lispdoc.lisp,v 1.1.1.1 2007/11/26 15:13:21 gorbag Exp $
New")


;;;;
;;;; $Id: lispdoc.lisp,v 1.1.1.1 2007/11/26 15:13:21 gorbag Exp $
;;;;
...
;; generate lispdoc for cl-lib

(defun generate-docfiles ()
  (lispdoc-html "~/Lisp/IRAD/CL-LIB/packages/" :chart :clos-facets :cl-lib-initializations :cl-lib-logic :cl-lib-console :transcripts)
  (lispdoc-html "~/Lisp/IRAD/CL-LIB/functions/" :cl-lib-essentials :cl-lib))
;; new eof
