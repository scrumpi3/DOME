  ...
  implements Serializable
{
  ...
  public static final Function f_plusone  = new Fplusone();
...
final class Fplusone extends Function {
  Fplusone() { super("plusone"); }
  public double f_to  (double x) { return x + 1 ; }
  public double f_from(double x) { return x - 1; }
}
