...
public class InterferenceResultCard extends JPanel
{
    ...
    private JPanel makeTopPanel() {
        ...
        JTextArea interferenceText1 = Templates.makeDTextArea("This plot provides the seal interference area at normal sections spaced along a section line that follows the edge of the door." +
                                                          " This line is made of the edges that makeup the door A line. Since the parametric geometry is a straight section for this demonstration, the intersection area is the same at every cross section.\n\n" +
                                                          "You may view the intersecting portions of the seal cross sections, " +
                                                            "provided that you have a default program to display VRML/WRL files on your computer. " +
        ...
        ImageIcon image = Templates.makeImageIcon("interferenceGUIwithGeometry/images/sectionLine.gif");
        ...
        GridBagConstraints[] gbcs = {
            ...
            new GridBagConstraints(1, 0, 1, 2, 0.0, 0.0, gbc.NORTHEAST, gbc.NONE, new Insets(5, 5, 5, 5), 0, 0)
        };
