 ...
 */
public abstract class ToolInterfaceDefinitionBuildPanel extends JPanel
{
    ...
    protected ToolInterfaceTreeBuilderPanel _causalityViewPanel;
...
//    protected ToolInterfaceTreeBuilderPanel sysCausalityPanel;
    ...
    public ToolInterfaceDefinitionBuildPanel(ToolInterfaceBuilder tInterface)
    {
    ...
    public void createComponents(DefaultContextBuilder interfaceContext, int numberColumns, String[] columnNames, int[] columnWidths)
    {
        ...
        _buildViewPanel = new ContextTreeBuilderPanel(interfaceContext, numberColumns, columnNames, columnWidths);
        _buildViewPanel.setBackground(Templates.DARKER_BACKGROUND_COLOR);
        _buildViewPanel.setUpDownBackgroundColour(Templates.DARKER_BACKGROUND_COLOR);

        nameField.setDomeObject(_buildViewPanel.getContextTree().getRootContext());

        ifaceViewsPanel.add(ToolInterface.BUILD_VIEW, _buildViewPanel);

        _causalityViewPanel = new ToolInterfaceTreeBuilderPanel(_tInterface, ToolInterface.CAUSALITY_VIEW);

        ifaceViewsPanel.add(ToolInterface.CAUSALITY_VIEW, _causalityViewPanel);
...
//        Model m = _tInterface.getModel();
    ...
    protected void setViewName(String currentView)
    {
