 ...
 */
public class FullWindNoiseToolGUI extends JPanel implements ActionListener
{
    ...
    private static final int CLOSING_SPRING_INDEX = 4;
    private static final int INTERFERENCE_SETUP_INDEX = 5;
    private static final int FEA_INDEX = 6;
    private static final int INTERFERENCE_RESULT_INDEX = 7;
    private static final int STANDARD_INDEX = 8;
    private static final int TEARDOWN_INDEX = 9;
    ...
    public FullWindNoiseToolGUI(ModelInterfaceBase iface){
        this();
        setInterface(iface);
    }
	...
	private JPanel makeRadioPanel()
	{
		...
		JComponent[] comps = {inputLabel, sealGeometry, doorGeometry, latch, air,
		                      closingSpring, interferenceSetup,
                              resultLabel,
                              feaResults, interferenceResults, standardResults, teardownResults, fill, imageLabel};
		// gridx, gridy, gridwidth, gridheight, weightx, weighty, anchor, fill, insets(t,l,b,r), ipadx, ipady
		GridBagConstraints[] gbcs = {
	...
	public void dispose()
	{
		SwingUtilities.windowForComponent(FullWindNoiseToolGUI.this).dispose();
	}
	...
	public static void main(String[] args)
	{
		...
		f.getContentPane().add(new FullWindNoiseToolGUI());
