...
public class StandardResultCard extends JPanel
{
    ...
    private JPanel makeTopPanel() {
        JPanel p = new JPanel();
        JLabel standardLabel = Templates.makeLabel("Standard closing effort results", Templates.FONT12B);
        JTextArea standardText1 = Templates.makeDTextArea("These results are determined byan ADAMS simulation which is part of the door closing effort tool.\n\nFor a standard analysis, the results include closing force, energy, door angle, velocity at sensor, and striker/latch force.Ê Each of these values is provided for the green seal at nominal position, and for the aged seal at nominal, inboard, and outboard conditions.");
        standardText1.setOpaque(false);

        ImageIcon image = Templates.makeImageIcon("fullWindNoiseToolGUI/images/standard.gif");
