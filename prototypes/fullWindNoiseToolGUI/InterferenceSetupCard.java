 ...
 */
public class InterferenceSetupCard extends JPanel
{
    ...
    private JPanel makeTopPanel() {
        JPanel p = new JPanel();
        JLabel analysisLabel = Templates.makeLabel("Interference analysis setup", Templates.FONT12B);
        JTextArea analysisText1 = Templates.makeDTextArea("These inputs affect the seal interfence analysis that is conducted on an I-deas based parametric model of the body/door/seal interface.\n\nThe interference analysis measures the area of interference between the weatherstrip bulb and the sealing surfaces.");
        analysisText1.setOpaque(false);

        ImageIcon image = Templates.makeImageIcon("fullWindNoiseToolGUI/images/sealInterferenceArea.gif");
	...
	{
		JFrame f = new JFrame("Interferfence setup card");
		f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		f.getContentPane().add(new InterferenceSetupCard());
		f.show();
	}
}
