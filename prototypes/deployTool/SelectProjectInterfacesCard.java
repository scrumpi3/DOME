...
public class SelectProjectInterfacesCard extends JPanel
{
	...
	{
		List interfaces = data.getToolProjectData().getInterfaces();
		...
		if (interfaces == null || interfaces.isEmpty()) {
			...
			interfaceSelectionCard.add("projectInterfacePanel", new DeployProjectInterfaceSelectionTable(data.getToolProjectData()));
		}
	...
	{
		data.getToolProjectData().addPropertyChangeListener(DeployProjectData.NUM_PROJECT_INT_AVAILABLE, selectListener);
	}

	public SelectProjectInterfacesCard(DeployTool deployData, DeployToolGui gui)
	{
		data = deployData;
		deployGui = gui;
