...
public class ConfirmCard extends JPanel
{
	...
	public void setConfirmCard()
	{
		...
		project.setText(data.getLocalToolPath());
		description.setText(data.getDescription());

		DeployProjectInterfaceSelectionTable pt = new DeployProjectInterfaceSelectionTable(data.getToolProjectData());
		...
		DeployIntegrationModelInterfaceSelectionTable mt = new DeployIntegrationModelInterfaceSelectionTable(data.getToolProjectData());
	...
	public ConfirmCard(DeployTool deployData, DeployToolGui gui)
	{
		data = deployData;
		deployGui = gui;
	...
	private JPanel makePanel()
	{
		...
		JComponent[] comps = {msg1, serverLabel, server, playspaceLabel, project, descriptionLabel, description,
		                      typeLabel, type, locationLabel, location, projectPanel, iModelPanel};
		// gridx, gridy, gridwidth, gridheight, weightx, weighty, anchor, fill, insets(t,l,b,r), ipadx, ipady
		GridBagConstraints[] gbcs = {
