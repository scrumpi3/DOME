 ...
 *
 ****************************************************************************/
package suspensionmodelcustomgui;
...
import solidworkBoltGui.SolidWorksCustomGui;
...
//		lengthUnit = Templates.makeLabel("unit");
		...
		thicknessValue = makeParameterTextField(thickness, true);
...
//        wallThicknessUnit = Templates.makeLabel("unit");
		...
		Parameter suspension = getParameterByName("suspension");
...
*/
		...
		final Parameter vrmlFileParam = getParameterByName("vrml");
