  ...
  implements Cloneable, Serializable
{
  ...
  static void reset() { case_sensitive = 0x00; }
  ...
  public Dimension dim() { return u_vec; }
 ...
 public String dump() {
  ...
  public double convertFrom(double mu1, Unit u1)
  {
    double mu2, x;
    Unit    u2 = this;
    System.out.println("u1.u_vec: " + String.valueOf(u1.u_vec));
    System.out.println("u2.u_vec: " + String.valueOf(u1.u_vec));
