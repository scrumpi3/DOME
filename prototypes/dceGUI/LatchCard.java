...
public class LatchCard extends JPanel
{
	...
	{
		JPanel p = new JPanel();
        JLabel latchLabel = Templates.makeLabel("Latch", Templates.FONT12B);
        JTextArea latchText1 = Templates.makeDTextArea("The latch is a simplified force versus deflection curve that was generated from a dynamic model of the latch.\n\n" +
        ...
        ImageIcon image = Templates.makeImageIcon("dceGUI/images/latch.gif");
