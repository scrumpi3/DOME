 ...
 */
public class DoorSealCard extends JPanel
{
    ...
    private JPanel makeTopPanel() {
        JPanel p = new JPanel();
        JLabel doorLabel = Templates.makeLabel("Door seal", Templates.FONT12B);
        ...
        ImageIcon image = Templates.makeImageIcon("dceGUI/images/doorSeal.gif");
	...
	public static void main(String[] args)
	{
		...
		f.getContentPane().add(new DoorSealCard());
		f.show();
	}
}
