 ...
 */
public class LatchGui extends JPanel implements ActionListener
{
    ...
    private static final int LATCH_INDEX = 0;
    ...
    public LatchGui(ModelInterfaceBase iface) {
        this();
        setInterface(iface);
    }
	/**
	...
	private JPanel makeRadioPanel()
	{
		...
		JComponent[] comps = {inputLabel, latch, resultLabel,
	...
	public void dispose()
	{
		SwingUtilities.windowForComponent(LatchGui.this).dispose();
	}
	...
	public static void main(String[] args)
	{
		...
		f.getContentPane().add(new LatchGui());
