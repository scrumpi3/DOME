 ...
 */
public class AirGui extends JPanel implements ActionListener
{
    ...
    public AirGui(ModelInterfaceBase iface) {
        this();
        setInterface(iface);
    }
	...
	private JPanel makeRadioPanel()
	{
		...
		JComponent[] comps = {inputLabel, air, resultLabel,
	...
	public void dispose()
	{
		SwingUtilities.windowForComponent(AirGui.this).dispose();
	}
	...
	public static void main(String[] args)
	{
		...
		f.getContentPane().add(new AirGui());
