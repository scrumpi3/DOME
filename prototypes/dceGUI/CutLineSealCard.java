 ...
 */
public class CutLineSealCard extends JPanel
{
    ...
    private JPanel makeTopPanel() {
        JPanel p = new JPanel();
        JLabel cutLabel = Templates.makeLabel("Cut line seal", Templates.FONT12B);
        JTextArea cutText1 = Templates.makeDTextArea("The cut line seal is defined by three sets of data:Ê geometry, stiffness, and damping.\n\n"+
                            ...
                            "conditions, plus locations slightly farther inboard(IB + X) and outboard(OB Ð X).");
        cutText1.setOpaque(false);

        ImageIcon image = Templates.makeImageIcon("dceGUI/images/cutLine.gif");
        JLabel imageLabel = new JLabel(image);
        imageLabel.setToolTipText("cut line seal nomenclature");

        JComponent[] comps = {cutLabel, cutText1, imageLabel};
        // gridx, gridy, gridwidth, gridheight, weightx, weighty, anchor, fill, insets(t,l,b,r), ipadx, ipady
        GridBagConstraints[] gbcs = {
    ...
    public void setInterface(ModelInterfaceBase iface) {
        CustomGui.connectStringOrNumberTextField(iface, "Percentage Cutline Seal Aging", age);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Damping Coefficient", damping);

        //todo note that the custom GUI does not have handle on the include ZONE booleans available in the interface
        //ab section
        CustomGui.connectBooleanCheckBox(iface, "Cutline Seal Include Zone AB", ab_include);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone AB Offset", ab_offset);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone AB Deflection O/B-(x)", ab_deflect[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone AB Deflection O/B", ab_deflect[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone AB Deflection Nominal", ab_deflect[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone AB Deflection I/B", ab_deflect[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone AB Deflection I/B+(x)", ab_deflect[IB_PLUS]);

        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone AB Load O/B-(x)", ab_load[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone AB Load O/B", ab_load[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone AB Load Nominal", ab_load[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone AB Load I/B", ab_load[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone AB Load I/B+(x)", ab_load[IB_PLUS]);

        //bc section
        CustomGui.connectBooleanCheckBox(iface, "Cutline Seal Include Zone BC", bc_include);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone BC Offset", bc_offset);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone BC Deflection O/B-(x)", bc_deflect[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone BC Deflection O/B", bc_deflect[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone BC Deflection Nominal", bc_deflect[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone BC Deflection I/B", bc_deflect[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone BC Deflection I/B+(x)", bc_deflect[IB_PLUS]);

        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone BC Load O/B-(x)", bc_load[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone BC Load O/B", bc_load[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone BC Load Nominal", bc_load[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone BC Load I/B", bc_load[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone BC Load I/B+(x)", bc_load[IB_PLUS]);

        //cd section
        CustomGui.connectBooleanCheckBox(iface, "Cutline Seal Include Zone CD", cd_include);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone CD Offset", cd_offset);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone CD Deflection O/B-(x)", cd_deflect[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone CD Deflection O/B", cd_deflect[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone CD Deflection Nominal", cd_deflect[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone CD Deflection I/B", cd_deflect[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone CD Deflection I/B+(x)", cd_deflect[IB_PLUS]);

        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone CD Load O/B-(x)", cd_load[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone CD Load O/B", cd_load[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone CD Load Nominal", cd_load[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone CD Load I/B", cd_load[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone CD Load I/B+(x)", cd_load[IB_PLUS]);

        //de section
        CustomGui.connectBooleanCheckBox(iface, "Cutline Seal Include Zone DE", de_include);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone DE Offset", de_offset);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone DE Deflection O/B-(x)", de_deflect[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone DE Deflection O/B", de_deflect[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone DE Deflection Nominal", de_deflect[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone DE Deflection I/B", de_deflect[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone DE Deflection I/B+(x)", de_deflect[IB_PLUS]);

        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone DE Load O/B-(x)", de_load[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone DE Load O/B", de_load[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone DE Load Nominal", de_load[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone DE Load I/B", de_load[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone DE Load I/B+(x)", de_load[IB_PLUS]);

        //ef section
        CustomGui.connectBooleanCheckBox(iface, "Cutline Seal Include Zone EF", ef_include);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone EF Offset", ef_offset);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone EF Deflection O/B-(x)", ef_deflect[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone EF Deflection O/B", ef_deflect[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone EF Deflection Nominal", ef_deflect[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone EF Deflection I/B", ef_deflect[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone EF Deflection I/B+(x)", ef_deflect[IB_PLUS]);

        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone EF Load O/B-(x)", ef_load[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone EF Load O/B", ef_load[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone EF Load Nominal", ef_load[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone EF Load I/B", ef_load[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone EF Load I/B+(x)", ef_load[IB_PLUS]);

        //fa section
        CustomGui.connectBooleanCheckBox(iface, "Cutline Seal Include Zone FA", fa_include);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone FA Offset", fa_offset);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone FA Deflection O/B-(x)", fa_deflect[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone FA Deflection O/B", fa_deflect[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone FA Deflection Nominal", fa_deflect[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone FA Deflection I/B", fa_deflect[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone FA Deflection I/B+(x)", fa_deflect[IB_PLUS]);

        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone FA Load O/B-(x)", fa_load[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone FA Load O/B", fa_load[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone FA Load Nominal", fa_load[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone FA Load I/B", fa_load[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Cutline Seal Zone FA Load I/B+(x)", fa_load[IB_PLUS]);
    }

	public static void main(String[] args)
	{
		JFrame f = new JFrame("Cut line seal card");
		f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		f.getContentPane().add(new CutLineSealCard());
		f.show();
	}
}
