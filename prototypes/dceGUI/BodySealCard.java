 ...
 */
public class BodySealCard extends JPanel
{
    ...
    private JPanel makeTopPanel() {
        JPanel p = new JPanel();
        JLabel bodyLabel = Templates.makeLabel("Body seal", Templates.FONT12B);
        JTextArea bodyText1 = Templates.makeDTextArea("The body seal is defined by three sets of data:Ê geometry, stiffness, and damping.\n\n" +
        ...
        bodyText1.setOpaque(false);

        ImageIcon image = Templates.makeImageIcon("dceGUI/images/bodySeal.gif");
        JLabel imageLabel = new JLabel(image);
        imageLabel.setToolTipText("body seal nomenclature");

        JComponent[] comps = {bodyLabel, bodyText1, imageLabel};
        // gridx, gridy, gridwidth, gridheight, weightx, weighty, anchor, fill, insets(t,l,b,r), ipadx, ipady
        GridBagConstraints[] gbcs = {
    ...
    public void setInterface(ModelInterfaceBase iface) {
        CustomGui.connectStringOrNumberTextField(iface, "Percentage Body Seal Aging", age);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Damping Coefficient", damping);

        //ab section
        CustomGui.connectBooleanCheckBox(iface, "Body Seal Include Zone AB", ab_include);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone AB Offset", ab_offset);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone AB Deflection O/B-(x)", ab_deflect[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone AB Deflection O/B", ab_deflect[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone AB Deflection Nominal", ab_deflect[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone AB Deflection I/B", ab_deflect[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone AB Deflection I/B+(x)", ab_deflect[IB_PLUS]);

        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone AB Load O/B-(x)", ab_load[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone AB Load O/B", ab_load[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone AB Load Nominal", ab_load[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone AB Load I/B", ab_load[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone AB Load I/B+(x)", ab_load[IB_PLUS]);

        //bc section
        CustomGui.connectBooleanCheckBox(iface, "Body Seal Include Zone BC", bc_include);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone BC Offset", bc_offset);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone BC Deflection O/B-(x)", bc_deflect[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone BC Deflection O/B", bc_deflect[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone BC Deflection Nominal", bc_deflect[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone BC Deflection I/B", bc_deflect[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone BC Deflection I/B+(x)", bc_deflect[IB_PLUS]);

        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone BC Load O/B-(x)", bc_load[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone BC Load O/B", bc_load[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone BC Load Nominal", bc_load[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone BC Load I/B", bc_load[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone BC Load I/B+(x)", bc_load[IB_PLUS]);

        //cd section
        CustomGui.connectBooleanCheckBox(iface, "Body Seal Include Zone CD", cd_include);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone CD Offset", cd_offset);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone CD Deflection O/B-(x)", cd_deflect[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone CD Deflection O/B", cd_deflect[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone CD Deflection Nominal", cd_deflect[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone CD Deflection I/B", cd_deflect[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone CD Deflection I/B+(x)", cd_deflect[IB_PLUS]);

        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone CD Load O/B-(x)", cd_load[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone CD Load O/B", cd_load[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone CD Load Nominal", cd_load[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone CD Load I/B", cd_load[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone CD Load I/B+(x)", cd_load[IB_PLUS]);

        //de section
        CustomGui.connectBooleanCheckBox(iface, "Body Seal Include Zone DE", de_include);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone DE Offset", de_offset);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone DE Deflection O/B-(x)", de_deflect[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone DE Deflection O/B", de_deflect[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone DE Deflection Nominal", de_deflect[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone DE Deflection I/B", de_deflect[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone DE Deflection I/B+(x)", de_deflect[IB_PLUS]);

        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone DE Load O/B-(x)", de_load[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone DE Load O/B", de_load[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone DE Load Nominal", de_load[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone DE Load I/B", de_load[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone DE Load I/B+(x)", de_load[IB_PLUS]);

        //ef section
        CustomGui.connectBooleanCheckBox(iface, "Body Seal Include Zone EF", ef_include);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone EF Offset", ef_offset);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone EF Deflection O/B-(x)", ef_deflect[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone EF Deflection O/B", ef_deflect[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone EF Deflection Nominal", ef_deflect[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone EF Deflection I/B", ef_deflect[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone EF Deflection I/B+(x)", ef_deflect[IB_PLUS]);

        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone EF Load O/B-(x)", ef_load[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone EF Load O/B", ef_load[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone EF Load Nominal", ef_load[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone EF Load I/B", ef_load[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone EF Load I/B+(x)", ef_load[IB_PLUS]);

        //fa section
        CustomGui.connectBooleanCheckBox(iface, "Body Seal Include Zone FA", fa_include);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone FA Offset", fa_offset);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone FA Deflection O/B-(x)", fa_deflect[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone FA Deflection O/B", fa_deflect[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone FA Deflection Nominal", fa_deflect[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone FA Deflection I/B", fa_deflect[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone FA Deflection I/B+(x)", fa_deflect[IB_PLUS]);

        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone FA Load O/B-(x)", fa_load[OB_MINUS]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone FA Load O/B", fa_load[OB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone FA Load Nominal", fa_load[NOMINAL]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone FA Load I/B", fa_load[IB]);
        CustomGui.connectStringOrNumberTextField(iface, "Body Seal Zone FA Load I/B+(x)", fa_load[IB_PLUS]);
    }

	public static void main(String[] args)
	{
		JFrame f = new JFrame("Body seal card");
		f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		f.getContentPane().add(new BodySealCard());
		f.show();
	}
}
