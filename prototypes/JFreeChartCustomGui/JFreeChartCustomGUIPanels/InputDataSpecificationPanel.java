...
import JFreeChartCustomGui.JFreeChartCustomGUIDataObjects.DayDataObject;
...
public class InputDataSpecificationPanel extends JPanel
{
	...
	{
		this._comboBoxDayNameUniqueTag = new Integer(7);

		// default value for number of days is 7
		this._numberOfDays = new Integer(DEFAULT_OF_SEVEN_DAYS);

		this._numberOfDaysHolder = Templates.makeTextField(this._numberOfDays.toString());
		this._numberOfDaysHolder.setEditable(false);
		_numberOfDaysHolder.setPreferredSize(new Dimension(100, 20));
		this._numberOfDaysHolder.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		this._addADay.addActionListener(new ActionListener()
		{
			...
			{
				InputDataSpecificationPanel.this.addOneDay();
			}
		});
		...
		this._removeADay.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				InputDataSpecificationPanel.this.removeOneDay();
			}
		});
		...
		this._dayComboBox.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				InputDataSpecificationPanel.this.bringCurrentDayDataObjectToFront();
	...
	{
        Integer oldValue = this._numberOfDays;
		this._numberOfDays = newValue;
	...
	protected JPanel makeDayInformationPanel()
	{
		...
		JComponent[] comps =
		        {
			        numberOfDaysLabel, this._numberOfDaysHolder, this._addADay, this._removeADay,
		...
		GridBagConstraints[] gbcs =
		        {
			        ...
			        new GridBagConstraints(0, 0, 1, 1, 0, 0, gbc.WEST, gbc.NONE, new Insets(0, 10, 0, 5), 0, 0),
			        new GridBagConstraints(1, 0, 1, 1, 1.0, 0, gbc.CENTER, gbc.HORIZONTAL, new Insets(0,0, 0, 0), 0, 0),
			        new GridBagConstraints(2, 0, 1, 1, 0, 0, gbc.WEST, gbc.NONE, new Insets(0, 10, 0, 0), 0, 0),
					new GridBagConstraints(3, 0, 1, 1, 0, 0, gbc.WEST, gbc.NONE, new Insets(0, 10, 0, 20), 0, 0),
			        // this._dayComboBox
			        new GridBagConstraints(0, 1, 4, 1, 1.0, 0.0, gbc.WEST, gbc.HORIZONTAL, new Insets(5, 20, 0, 20), 0, 0),

			        // JPanel spacer
			        new GridBagConstraints(0, 2, 4, 1, 1.0, 0, gbc.WEST, gbc.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0),

			        // this._dayAttributesLabel
			        new GridBagConstraints(0, 3, 4, 1, 1.0, 0, gbc.WEST, gbc.HORIZONTAL, new Insets(10, 0, 0, 0), 0, 0),

			        // this._nameLabel, this._editableNameOfDayField
			        new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0, gbc.WEST, gbc.NONE, new Insets(5, 10, 0, 0), 0, 0),
			        new GridBagConstraints(1, 4, 3, 1, 1.0, 0.0, gbc.WEST, gbc.HORIZONTAL, new Insets(5, 10, 0, 20), 0, 0),

			        // this._numberOfDaysRepresentedLabel, this._numberOfDaysRepresentedTextField, this._days
			        new GridBagConstraints(0, 5, 1, 1, 0, 0, gbc.WEST, gbc.NONE, new Insets(5, 10, 0, 0), 0, 0),
			        new GridBagConstraints(1, 5, 2, 1, 1.0, 0.0, gbc.WEST, gbc.HORIZONTAL, new Insets(5, 10, 0, 0), 0, 0),
			        new GridBagConstraints(3, 5, 1, 1, 0.0, 0.0, gbc.WEST, gbc.NONE, new Insets(5, 5, 0, 20), 0, 0),

			        // this._numberOfDaysinYearAccountedForLabel
			        new GridBagConstraints(0, 6, 4, 1, 1.0, 0, gbc.WEST, gbc.HORIZONTAL, new Insets(20, 10, 20, 0), 0, 0),
...
//			        new GridBagConstraints(0, 7, 4, 1, 1.0, 1.0, gbc.WEST, gbc.BOTH, new Insets(0, 0, 0, 0), 0, 0)
	...
	public JPanel makeMarketInformationPanel()
	{
		...
		GridBagConstraints[] gbcs = {
			...
			// JPanel spacer
			new GridBagConstraints(0, 3, 3, 1, 1.0, 1.0, gbc.WEST, gbc.BOTH, new Insets(0, 0, 0, 0), 0, 0)
	...
	public void makeInputDataSpecificationPanel()
	{
        ...
        GridBagConstraints[] gbcs = {
	        ...
	        /// dayInformationPanel
	        new GridBagConstraints(0, 0, 1, 1, 1.0, 0, gbc.NORTH, gbc.BOTH, new Insets(0, 0, 0, 0), 0, 0),
