...
public class ConfigCard extends JPanel
{
    ...
    private JPanel makeTopPanel() {
        ...
        JTextArea analysisText1 = Templates.makeDTextArea("The seal gap analyzer assesses the space occupied by the weatherstip between a closure panel, such as a door inner panel, and the body structure.\n\n"+
        ...
        ImageIcon image = Templates.makeImageIcon("interferenceGUI/images/seal.gif");
    ...
    private JPanel makeConfigPanel() {
        ...
        JLabel sectionSpacingLabel = Templates.makeLabel("Cross section spacing (mm): ");
