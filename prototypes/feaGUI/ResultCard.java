...
public class ResultCard extends JPanel
{
    ...
    private JPanel makeTopPanel() {
        ...
        JTextArea analysisText1 = Templates.makeDTextArea("This CLD plot shows the analysis results for your input configuration.\n\nYou may view an amination of the seal's deformation, " +
                                                          ...
                                                          " Immediately after the first run you will be prompted to select where the movie file should be saved on your computer.\n"
                                                          );
        analysisText1.setOpaque(false);

        JComponent[] comps = {analysisLabel, analysisText1};
        // gridx, gridy, gridwidth, gridheight, weightx, weighty, anchor, fill, insets(t,l,b,r), ipadx, ipady
        GridBagConstraints[] gbcs = {
	...
	public static void main(String[] args)
	{
		...
		f.getContentPane().add(new ResultCard());
		f.show();
	}
}
