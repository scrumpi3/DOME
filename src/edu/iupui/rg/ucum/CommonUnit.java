...
"J_p_m = 1 J/m metric | force | Joule per meter" + "\n" +
...
"[rho] = 1 s2.A2/kg/m metric | constant | permeability coefficient" + "\n" +
...
"[N_A2] = 1 N/A2 metric | magnetic permeability | Newton per Ampere Squared" + "\n" +
"[H_m] = 1 H/m metric | magnetic permeability | Henry per Meter" + "\n" +
...
"" + "\n" +
"[K_lc] = 1 Pa.m1/2 metric | fracture toughness | pascal square root meter" + "\n" +
"" + "\n" +
