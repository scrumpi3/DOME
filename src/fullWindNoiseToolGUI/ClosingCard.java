...
public class ClosingCard extends JPanel
{
    ...
    private JPanel makeTopPanel() {
        ...
        JTextArea closingText1 = Templates.makeDTextArea("The closing spring stiffness, preload, and location is defined in this panel. " +
                                                "Use the door CG for the spring location only if you are unsure of the correct location. These inputs are used by the ADAMS closing effort simulations\n\n" +
                                                "If a parametric CAD model of the full door was avalable as part of this pilot application, the spring location would not have to be input manually.");
        closingText1.setOpaque(false);

        ImageIcon image = Templates.makeImageIcon("fullWindNoiseToolGUI/images/closingSpring.gif");
    ...
    private JPanel makeLatchPanel() {
        ...
        GridBagConstraints[] gbcs = {
            ...
            new GridBagConstraints(3, 1, 1, 1, 1.0, 0.0, gbc.CENTER, gbc.HORIZONTAL, new Insets(2, 5, 0, 5), 0, 0),
