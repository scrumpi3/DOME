 ...
 */
public class SealWindNoiseToolGUI extends JPanel implements ActionListener
{
    ...
    private static final int INTERFERENCE_SETUP_INDEX = 1;
    private static final int FEA_INDEX = 3;
    private static final int INTERFERENCE_RESULT_INDEX = 2;
    private static final int STANDARD_INDEX = 4;
    private static final int TEARDOWN_INDEX = 5;
    ...
    public SealWindNoiseToolGUI(ModelInterfaceBase iface){
        this();
        setInterface(iface);
    }
	...
	private JPanel makeRadioPanel()
	{
		...
		JComponent[] comps = {inputLabel, sealGeometry, //doorGeometry, latch, air, closingSpring,
                              interferenceSetup,
                              resultLabel,
	...
	public void dispose()
	{
		SwingUtilities.windowForComponent(SealWindNoiseToolGUI.this).dispose();
	}
	...
	public static void main(String[] args)
	{
		...
		f.getContentPane().add(new SealWindNoiseToolGUI());
