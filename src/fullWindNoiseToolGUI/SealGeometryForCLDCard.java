 ...
 */
public class SealGeometryForCLDCard extends JPanel
{
    ...
    private JPanel makeTopPanel() {
        ...
        JTextArea analysisText1 = Templates.makeDTextArea("This panel is used to configure the door (primary) seal and outer body geometry. " +
                ...
                "These parameters affect a 3D parametric CATIA model of the body/seal/door segment and the parametric I-deas CAD model that is used for seal interference analysis.\n\n" +
...
//        showGeometry.setToolTipText("If checked, a 3D CATIA geometry visualization will open and update in a VRML viewer");
        ...
        cornerRadiusLabel.setToolTipText("Allowable corner radius range is >3 - <6 mm");
        ...
        sealHeightLabel.setToolTipText("Allowable seal height range is >10 to <14 mm");
	...
	public static void main(String[] args)
	{
		...
		f.getContentPane().add(new SealGeometryForCLDCard());
		f.show();
	}
}
