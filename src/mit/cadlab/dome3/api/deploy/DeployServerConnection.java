...
public class DeployServerConnection {
    public static String USER = "USER";
    public static String GUEST = "GUEST";
    public static String USERS = "USERS";
    public static String GROUPS = "GROUPS";
    public static String SERVER = "SERVER";
    public static String MODEL_PERMISSIONS = PermissionUtils.MODEL_IPROJECT_EDIT_PRIVILEGES;
    public static String INTERFACE_PERMISSIONS = PermissionUtils.MODEL_IPROJECT_INTERFACE_USE_PRIVILEGES;
    ServerConnection conn;

    public DeployServerConnection(String username, String password, String logintype, String serverIP) {
