 ...
 */
public class UgDimensionOutNew extends AbstractPluginData
{
	...
	public UgDimensionOutNew(UgPluginCaller caller, long modelPtr, String dims)
	{
		this(caller, modelPtr, dims, null);
	}

	public UgDimensionOutNew(UgPluginCaller caller, long modelPtr, String dims, Parameter domeReal)
	{
		this.caller = caller;
		this.parameter = domeReal;
		String[] arr = new String[1];
		arr[0] = dims;
		exDimObj = caller.callObjectFunc(modelPtr, UgPluginCaller.COMPONENT_CREATE_DIMENSIONOUT, arr);
		if (exDimObj == -1) {
...
*/
	public double getDimValue(boolean isNativeCall)
	{
		...
		return caller.callDoubleFunc(exDimObj, UgPluginCaller.DIMENSIONOUT_GET_VALUE, null);
	}
