 ...
 */
public class IdeasDimensionIn extends AbstractPluginData
{
	public static final String CLASS = "IdeasDimensionIn";
	public static final String GTNAME = "IdeasDimensionIn::getName";
	public static final String GTUNIT = "IdeasDimensionIn::getUnit";
	public static final String GTVAL = "IdeasDimensionIn::getValue";
	public static final String STVAL = "IdeasDimensionIn::setValue";
	...
	public IdeasDimensionIn(IdeasNativeCaller caller, long modelPtr, String dims, String DimInOrOut)
	{
		this(caller, modelPtr, dims, DimInOrOut, null);
	}

	public IdeasDimensionIn(IdeasNativeCaller caller, long modelPtr, String dims, String DimInOrOut, mit.cadlab.dome3.objectmodel.dataobject.interfaces.DomeReal domeReal)
	{
		this.caller = caller;
