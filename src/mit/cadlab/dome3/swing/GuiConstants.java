...
public interface GuiConstants
{
	...
	public static final Color INCONSISTENT_COLOR = new Color(246, 150, 121);
	public static final Color WAITING_VALIDATION_COLOR = new Color(196, 223, 155);
	public static final Color CONSISTENT_COLOR = Color.white;
