...
public class MenuUtils implements GuiConstants
{
    ...
    public static JMenuItem makeCheckBoxMenuItem(String txt,ItemListener l){
        JMenuItem m= makeCheckBoxMenuItem(txt);
        m.addItemListener(l);
        return m;
     }

      public static JMenuItem makeCheckBoxMenuItem(String txt,boolean select,ItemListener l){
        JMenuItem m= makeCheckBoxMenuItem(txt);
