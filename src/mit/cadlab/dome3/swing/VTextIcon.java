...
/**
 ...
 It's useful for JTabbedPanes with LEFT or RIGHT_OPTION tabs but can be used in any
...
public class VTextIcon implements Icon, PropertyChangeListener
{
	...
	/**
	 ...
	 This is public static so you can use it to test2 a string without creating a VTextIcon
