 ...
 */
public class BrowseModelTest extends JFrame
{
	...
	public static void main(String[] args)
	{
		...
		try {
			...
			// m_serverConnection = getServerConnection(LoginUtils.USER, "qing", "localhost:8080", "111");
			//m_serverConnection = getServerConnection(LoginUtils.ENTER, "amelie", "localhost:8080", "girl");
			m_serverConnection = getServerConnection(LoginUtils.USER, "Charles", "localhost:8080", "123");
			//m_serverConnection = getServerConnection(LoginUtils.ADMIN, "amelie", "localhost:8080", "girl");
			//UserGroupDbFunctions.editUserGroupInfo(0,"root", "", true, true, "ACTIVE");

			myselfTable = new BrowseModelFileSystemTable(m_serverConnection, Folder.USER_HOME);
			usersTable = new BrowseModelFileSystemTable(m_serverConnection, Folder.USERS_ROOT);
			groupsTable = new BrowseModelFileSystemTable(m_serverConnection, Folder.GROUPS_ROOT);
			serverTable = new BrowseModelFileSystemTable(m_serverConnection, Folder.SERVER_ROOT);
