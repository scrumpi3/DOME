 ...
 */
public class PlayspaceRunPlayspaceTableObject extends AbstractTableObject
{
	...
	public PlayspaceRunPlayspaceTableObject(ParameterRuntime parameter)
	{
		super(parameter);
	...
	public Object getValueAt(int column)
	{
		if (column == 0)
			...
			//return ((DomeInteger)data).getIntegerValue();
				...
				return data;
			else if (data instanceof mit.cadlab.dome3.objectmodel.dataobject.interfaces.DomePreference)
				return data;
