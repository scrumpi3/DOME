...
public class JarResources
{
	...
	/**
	 * Is a test2 driver. Given a jar file and a resource name, it trys to
    ...
    /**
     * Qing: add a access point of the content hastable
     * this will help people to know the content inside
     */
    public  Enumeration getContents() {
        return htJarContents.keys();
    }
