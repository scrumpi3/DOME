 ...
 */
public class CustomGuiChooser extends JDialog
{
	...
	{
		CustomGuiChooser chooser = new CustomGuiChooser(comp, mInterface);
		chooser.show();
	}

    public static void showDialog(JComponent comp, ToolInterface tInterface)
    {
        CustomGuiChooser chooser = new CustomGuiChooser(comp, tInterface);
        chooser.show();
    }
    ...
    ToolInterface _tInterface = null; // todo: tool interface will extend from model interface very soon!
	// static String[] answer = null;

	protected CustomGuiChooser(Component comp, ModelInterface mInterface)
	{
    ...
    protected CustomGuiChooser(Component comp, ToolInterface tInterface)
    {
	...
	protected void commitAction()
	{
        ...
        if (mInterface != null)
		    mInterface.addCustomGui(new CustomGuiInfo(classname, name, filepath));
        if (_tInterface != null)
            _tInterface.addCustomGui(new CustomGuiInfo(classname, name, filepath));
		dispose();
	}
	...
	public static void main(String[] args)
	{
		...
		CustomGuiChooser.showDialog(null, (ModelInterface)null);
	}
