...
public class EditProjectPrivCard extends JPanel
{
	...
	public void setEditPrivPanel()
	{
		...
		} else if (PermissionFunctions.sessionUserHasPermission(data.getServerConnection(), data.getRedeployProjectId(), PermissionUtils.PERMISSION_TO_SET_MODEL_EDIT_PRIV)) {
	...
	public EditProjectPrivCard(DeployProject deployData, DeployProjectGui gui)
	{
		data = deployData;
		deployGui = gui;
