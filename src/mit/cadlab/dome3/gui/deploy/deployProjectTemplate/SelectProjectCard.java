...
public class SelectProjectCard extends JPanel implements ActionListener
{
	...
	public SelectProjectCard(DeployProjectTemplate deployData, DeployProjectGui gui)
	{
		data = deployData;
		deployGui = gui;
		parent = this;
	...
	private JPanel makePanel()
	{
		...
		deployNew = Templates.makeRadioButton("Deploy as new Project Template", true);
		...
		GridBagConstraints[] gbcs = {
			...
			new GridBagConstraints(0, 4, 2, 1, 1.0, 0.0, gbc.CENTER, gbc.HORIZONTAL, new Insets(2, 5, 0, 0), 0, 0),
			new GridBagConstraints(0, 5, 2, 1, 1.0, 1.0, gbc.CENTER, gbc.BOTH, new Insets(0, 0, 0, 0), 0, 0)
		};
