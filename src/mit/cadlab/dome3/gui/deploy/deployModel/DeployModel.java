...
public class DeployModel {
    ...
    private SelectLocationCard selectLocationCard;
    private SetModelPrivCard setModelPrivCard;
    private SelectInterfaceCard selectInterfaceCard;
    private SetInterfacePrivCard setInterfacePrivCard;
    ...
    public SetInterfacePrivCard getSetInterfacePrivCard() {
        return setInterfacePrivCard;
    }

    public void setSetInterfacePrivCard(SetInterfacePrivCard setInterfacePrivCard) {
        this.setInterfacePrivCard = setInterfacePrivCard;
    }
    ...
    public SetModelPrivCard getSetModelPrivCard() {
        return setModelPrivCard;
    }

    public void setSetModelPrivCard(SetModelPrivCard setModelPrivCard) {
        this.setModelPrivCard = setModelPrivCard;
    }
    ...
    public SelectLocationCard getSelectLocationCard() {
        return selectLocationCard;
    }

    public void setSelectLocationCard(SelectLocationCard selectLocationCard) {
        this.selectLocationCard = selectLocationCard;
    }
