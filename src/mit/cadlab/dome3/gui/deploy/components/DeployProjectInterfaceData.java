...
public class DeployProjectInterfaceData
{
	...
	public DeployProjectInterfaceData(String path, String xmlContent, String xmlMappingsContent, String id, String name)
	{
		this._pathName = path;
