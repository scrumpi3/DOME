...
public class DeployProjectInterfaceSelectionTable extends JScrollPane
{
	...
	public DeployProjectInterfaceSelectionTable(DeployProjectData project)
	{
		this(project, null);

	}

	protected DeployProjectInterfaceSelectionTable(DeployProjectData project, TreeSelectionModel selectionModel)
	{
		if (project == null)
	...
	protected TableObjectFactory createTableObjectFactory()
	{
		...
		factory.registerTableObjectInfo("mit.cadlab.dome3.gui.deploy.components.DeployProjectInterfaceData", "mit.cadlab.dome3.gui.deploy.components.DeployProjectInterfaceTableObject");
	...
	{
		return new DeployProjectInterfaceTreeNode(project);
	}
