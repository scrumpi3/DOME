...
public class DeployProjectInterfaceTreeNode extends AbstractTreeObjectFactoryTreeNode
{

	private static TreeObjectFactory treeObjFactory = createTreeObjectFactory();

	public DeployProjectInterfaceTreeNode(Object projectData)
	{
		super(projectData);
	}
	...
	private static TreeObjectFactory createTreeObjectFactory()
	{
		...
		factory.registerTreeObjectInfo("mit.cadlab.dome3.gui.deploy.components.DeployProjectInterfaceData", "mit.cadlab.dome3.gui.deploy.components.DeployProjectInterfaceTreeObject");
