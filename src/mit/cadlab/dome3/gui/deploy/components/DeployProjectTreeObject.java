...
//TODO:
//TODO: this class is identical to DeployProjectInterfacesTreeObject.java
//TODO: if not used could be deleted?
//TODO:

public class DeployProjectTreeObject extends DefaultTreeObject
{
	protected DeployProjectData project;

	public DeployProjectTreeObject(DeployProjectData project)
	{
		super(project, true);
