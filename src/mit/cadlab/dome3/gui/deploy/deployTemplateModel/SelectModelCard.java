...
public class SelectModelCard extends JPanel implements ActionListener
{
	...
	public SelectModelCard(DeployModelTemplate deployData, DeployModelGui gui)
	{
		data = deployData;
		deployGui = gui;
	...
	private JPanel makePanel()
	{
		...
		JComponent[] comps = {msg1, path, browse, deployNew, descriptionLabel, modelDescription, fill};
		// gridx, gridy, gridwidth, gridheight, weightx, weighty, anchor, fill, insets(t,l,b,r), ipadx, ipady
		GridBagConstraints[] gbcs = {
