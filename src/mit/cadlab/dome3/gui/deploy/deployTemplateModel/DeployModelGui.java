...
public class DeployModelGui extends JPanel implements ActionListener
{
	...
	public static final int INTERFACE_SEL = 2;
	 ...
	 */
	public DeployModelGui(DeployModelTemplate deployModel)
	{
		data = deployModel;
	...
	private JPanel makeRadioPanel()
	{
		...
		JComponent[] comps = {login, selModel, selInterfaces, confirm, fill};
		// gridx, gridy, gridwidth, gridheight, weightx, weighty, anchor, fill, insets(t,l,b,r), ipadx, ipady
		GridBagConstraints[] gbcs = {
		...
		JRadioButton[] buttonsTemp = new JRadioButton[]{login, selModel,selInterfaces, confirm};
		buttons = buttonsTemp;
		return p;
	}
