...
//    protected ToolInterfaceTreeBuilderPanel sysCausalityPanel;
    ...
    public ToolInterfaceDefinitionBuildPanel(AnalysisToolInterfaceBase tInterface)
    {
    ...
    public void createComponents(DefaultContextBuilder interfaceContext, int numberColumns, String[] columnNames, int[] columnWidths)
    {
        ...
        _buildViewPanel = new ContextTreeBuilderPanel(interfaceContext, OptimizationInterfaceBuild.QMOO_INTERFACE_BUILD_VIEW_PARAMETER,
    ...
    {
        return ModeContexts.BUILD_TOOLMODEL_INTERFACE_BUILDVIEW;
    }
