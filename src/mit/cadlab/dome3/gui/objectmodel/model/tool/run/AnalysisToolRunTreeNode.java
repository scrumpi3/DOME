 ...
 */
public class AnalysisToolRunTreeNode extends AbstractTreeObjectFactoryTreeNode
{

	private static TreeObjectFactory treeObjFactory = createTreeObjectFactory();

	public AnalysisToolRunTreeNode(Object fileSystemObject)
	{
	...
	private static TreeObjectFactory createTreeObjectFactory()
	{
        ...
        factory.registerTreeObjectInfo("mit.cadlab.dome3.network.client.objectrecord.ClientAnalysisToolRecord",
                                       "mit.cadlab.dome3.gui.playspace.treeobject.PlayspaceAnalysisToolTreeObject");
        ...
        factory.registerTreeObjectInfo("mit.cadlab.dome3.network.client.objectrecord.ClientAnalysisToolInterfaceRecord",
                                       "mit.cadlab.dome3.gui.playspace.treeobject.PlayspaceAnalysisToolInterfaceTreeObject");
