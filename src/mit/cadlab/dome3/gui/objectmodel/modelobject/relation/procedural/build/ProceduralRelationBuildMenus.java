...
public class ProceduralRelationBuildMenus {
    public static final ProceduralRelationBuildMenus menus = new ProceduralRelationBuildMenus();

    // editMenu
    protected JMenu editMenu = MenuUtils.makeBoldMenu("Edit procedural relation");
    ...
    private ProceduralRelationBuildMenus() {
//renu        List dataTypes = Registry.getValidDataTypes();
        ...
        for (int i=0; i<dataTypeMIs.length; ++i)
            dataTypeMIs[i] = MenuUtils.makeMenuItem(new ProceduralRelationTreeBuilderPanel.AddItemAction((String)dataTypes.get(i)));
        copyMI = MenuUtils.makeMenuItem(ProceduralRelationTreeBuilderPanel.copyAction);
        pasteCopyLastSelectionMI = MenuUtils.makeMenuItem(ProceduralRelationTreeBuilderPanel.pasteCopyLastSelectionAction);
        pasteCopyClipboardMI = MenuUtils.makeMenuItem(ProceduralRelationTreeBuilderPanel.pasteCopyClipboardAction);
        mapLastSelectionMI = MenuUtils.makeMenuItem(ProceduralRelationTreeBuilderPanel.mapLastSelectionAction);
        mapClipboardMI = MenuUtils.makeMenuItem(ProceduralRelationTreeBuilderPanel.mapClipboardAction);
        addAndMapLastSelectionMI = MenuUtils.makeMenuItem(ProceduralRelationTreeBuilderPanel.addAndMapLastSelectionAction);
        addAndMapClipboardMI = MenuUtils.makeMenuItem(ProceduralRelationTreeBuilderPanel.addAndMapClipboardAction);
        deleteMI = MenuUtils.makeMenuItem(ProceduralRelationTreeBuilderPanel.deleteAction);
        relationTestMI = MenuUtils.makeMenuItem(ProceduralRelationTreeBuilderPanel.TestAction);
       ...
       // addAndMapIndex = editMenu.getItemCount();
        ...
        editMenu.add(MenuUtils.makeMenuItem(ProceduralRelationTreeBuilderPanel.clearSelectionAction));
        editMenu.add(MenuUtils.makeMenuItem(ProceduralRelationTreeBuilderPanel.selectAllAction));
        editMenu.addSeparator();
