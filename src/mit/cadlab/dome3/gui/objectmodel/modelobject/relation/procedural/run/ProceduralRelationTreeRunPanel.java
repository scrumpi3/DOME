...
public class ProceduralRelationTreeRunPanel extends JPanel
{

	public static GridBagConstraints gbc;
	protected ConcreteProceduralRelation relationBuilder;
	protected RunProceduralRelationTree tree;
	protected RunTreeTable treeTable;

	public ProceduralRelationTreeRunPanel(ConcreteProceduralRelation relationBuilder,
	                                      String view)
	{
		this.relationBuilder = relationBuilder;
		tree = new RunProceduralRelationTree(relationBuilder, view);
