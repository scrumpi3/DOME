...
import mit.cadlab.dome3.gui.objectmodel.modelobject.relation.procedural.build.BuildProceduralRelationTree;
...
public class ProceduralRelationTreeBuilderPanel extends TreeBuilderPanel
{

	protected ConcreteProceduralRelation relationBuilder;
	protected BuildProceduralRelationTree tree;
	protected BuildTreeTable treeTable;

	public ProceduralRelationTreeBuilderPanel(ConcreteProceduralRelation relationBuilder,
	                                          String view)
	{
		this.relationBuilder = relationBuilder;
//		this.relationBuilder.addModelObjectsListener(new RelationListener());
		tree = new BuildProceduralRelationTree(relationBuilder, view);
		tree.addTreeSelectionListener(new ProceduralRelationBuilderTreeSelectionListener());
	...
	public void deleteSelectedModelObjects()
	{
		...
		Model m = relationBuilder.getModel();
		if(m instanceof DomeModel) {
			ConnectionMappingManager mgr =((DomeModel)m).getMappingManager();
			Context filecontext = ((DomeModelBuilder)m).getFileContext();
			for (Iterator iterator = selectedDomeObjects.iterator(); iterator.hasNext();) {
				Object domeObject = iterator.next();
				if(domeObject instanceof Parameter) {
					mgr.removeAllMappings((Parameter) domeObject);
					DataObject dobj = ((Parameter)domeObject).getCurrentDataObject();
					if(dobj instanceof DomeFile) {
						filecontext.removeModelObjectReference((ModelObject)domeObject);
					}
				}
			}
		}
		else if(m instanceof PluginModel) {
			PluginMappingManager mgr = ((PluginModel) m).getPluginMappingManager();
			for (Iterator iterator = selectedDomeObjects.iterator(); iterator.hasNext();) {
				Object domeObject = iterator.next();
				if (domeObject instanceof Parameter) {
					mgr.removeAllMappings((Parameter) domeObject);
		...
		else if(m instanceof AnalysisTool) {
			ConnectionMappingManager mgr = ((AnalysisTool) m).getMappingManager();
			for (Iterator iterator = selectedDomeObjects.iterator(); iterator.hasNext();) {
				Object domeObject = iterator.next();
				if (domeObject instanceof Parameter) {
					mgr.removeAllMappings((Parameter) domeObject);
...
//                    System.out.println("3");
	...
	protected void setEditMenusForSelection()
	{
		...
		if (selectionCount > 1) {
			ProceduralRelationBuildMenus.menus.disableAddMenus();
		} else if (selectionCount == 1) {
			ProceduralRelationBuildMenus.menus.enableAddMenus();
			if (isRelationParameterSelected()) {
				ProceduralRelationBuildMenus.menus.enableMapMIs();
			} else {
				ProceduralRelationBuildMenus.menus.disableMapMIs();
			}
		...
		if (selectionCount == 0) {
			ProceduralRelationBuildMenus.menus.disableRemoveMenus();
		} else {
			ProceduralRelationBuildMenus.menus.enableRemoveMenus();
		}
	...
	class ProceduralRelationBuilderTreeSelectionListener implements TreeSelectionListener
	{
...
*/
	...
	public static abstract class FocusTrackerAction extends AbstractAction
	{
		...
		protected final ProceduralRelationTreeBuilderPanel getProceduralRelationTreeBuilderPanel(ActionEvent e)
		{
			if (e != null) {
				Object o = e.getSource();
				if (o instanceof ProceduralRelationTreeBuilderPanel) {
					return (ProceduralRelationTreeBuilderPanel) o;
				}
			}
			JComponent comp = BuildFocusTracker.getCurrentComponent();
			if (comp instanceof ProceduralRelationTreeBuilderPanel)
				return (ProceduralRelationTreeBuilderPanel) comp;
			/**/System.err.println("No current ProceduralRelationTreeBuilderPanel");
			throw new NullPointerException("No current ProceduralRelationTreeBuilderPanel");
		}
	}
	...
	public static class AddItemAction extends FocusTrackerAction
	{
		...
		{
			getProceduralRelationTreeBuilderPanel(e).addNewModelObject((String) getValue(AbstractAction.NAME));
		}
	}
	...
	public static final AbstractAction copyAction = new FocusTrackerAction("Copy")
	{
		public void actionPerformed(ActionEvent e)
		{
			getProceduralRelationTreeBuilderPanel(e).copySelectedModelObjects();
		}
	};
	...
	public static final AbstractAction pasteCopyLastSelectionAction = new FocusTrackerAction("Last selection")
	{
		public void actionPerformed(ActionEvent e)
		{
			getProceduralRelationTreeBuilderPanel(e).pasteCopyLastSelection();
		}
	};
	...
	public static final AbstractAction pasteCopyClipboardAction = new FocusTrackerAction("Clipboard...")
	{
		public void actionPerformed(ActionEvent e)
		{
			getProceduralRelationTreeBuilderPanel(e).pasteCopyFromClipboard();
		}
	};
	...
	public static final AbstractAction mapLastSelectionAction = new FocusTrackerAction("Last selection")
	{
		public void actionPerformed(ActionEvent e)
		{
			getProceduralRelationTreeBuilderPanel(e).mapLastSelection();
		}
	};
	...
	public static final AbstractAction mapClipboardAction = new FocusTrackerAction("Clipboard...")
	{
		public void actionPerformed(ActionEvent e)
		{
			getProceduralRelationTreeBuilderPanel(e).mapFromClipboard();
		}
	};
	...
	public static final AbstractAction addAndMapLastSelectionAction = new FocusTrackerAction("Last selection")
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			getProceduralRelationTreeBuilderPanel(e).addAndMapLastSelection();
	...
	public static final AbstractAction addAndMapClipboardAction = new FocusTrackerAction("Clipboard...")
	{
		public void actionPerformed(ActionEvent e)
		{
			getProceduralRelationTreeBuilderPanel(e).addAndMapFromClipboard();
		}
	};
	...
	public static final AbstractAction deleteAction = new FocusTrackerAction("Delete")
	{
		public void actionPerformed(ActionEvent e)
		{
			getProceduralRelationTreeBuilderPanel(e).deleteSelectedModelObjects();
		}
	};
	...
	public static final AbstractAction clearSelectionAction = new FocusTrackerAction("Clear selection")
	{
		public void actionPerformed(ActionEvent e)
		{
			getProceduralRelationTreeBuilderPanel(e).tree.clearSelection();
		}
	};
	...
	public static final AbstractAction selectAllAction = new FocusTrackerAction("Select all")
	{
		public void actionPerformed(ActionEvent e)
		{
			getProceduralRelationTreeBuilderPanel(e).tree.selectAllVisibleRows();
		}
	};
	...
	public static final AbstractAction TestAction = new FocusTrackerAction("Test")
	{
		public void actionPerformed(ActionEvent e)
		{
			ProceduralRelationTreeBuilderPanel p = getProceduralRelationTreeBuilderPanel(e);
			if (p == null) {
				System.err.println("Test cancelled: unable to find a current (focused) ProceduralRelation");
				return;
			}
			try {
