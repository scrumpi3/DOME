...
// downloaded from http://iharder.sourceforge.net/base64/
	...
	public static void main(String[] args)
	{
		try {
			...
			// Test Input Stream
			{
				...
				java.io.FileInputStream fis = null;//new java.io.FileInputStream( "test2.gif.b64" );
				InputStream b64is = null;//new Base64.InputStream( fis, DECODE );
				...
				b64is.close();
				*/
				bytes = Base64.readFile("test2.gif.b64", false);
				javax.swing.ImageIcon iicon = new javax.swing.ImageIcon(bytes);
				javax.swing.JLabel jlabel = new javax.swing.JLabel("Read from test2.gif.b64", iicon, 0);
				...
				java.io.FileOutputStream fos = new java.io.FileOutputStream("test2.gif_out");
				fos.write(bytes);
				fos.close();


				// Read raw bytes and encode
				fis = new java.io.FileInputStream("test2.gif_out");
				...
				jframe.setTitle("Read from test2.gif_out");
				jframe.getContentPane().add(jsp);
				jframe.pack();
				jframe.show();

				// Write encoded bytes to file
				fos = new java.io.FileOutputStream("test2.gif.b64_out");
				fos.write(ebytes);

				// Read GIF stored in base64 form.
				fis = new java.io.FileInputStream("test2.gif.b64_out");
				...
				jlabel = new javax.swing.JLabel("Read from test2.gif.b64_out", iicon, 0);
				jframe = new javax.swing.JFrame();
				jframe.getContentPane().add(jlabel);
				jframe.pack();
				jframe.show();
			...
			{
				// Read raw bytes
				java.io.FileInputStream fis = new java.io.FileInputStream("test2.gif_out");
				...
				java.io.FileOutputStream fos = null;//new java.io.FileOutputStream("test2.gif.b64_out2");
				OutputStream b64os = null;//new Base64.OutputStream( fos, ENCODE );
				//b64os.write( rbytes );
				//b64os.close();
				Base64.writeFile(rbytes, "test2.gif.b64", ENCODE);

				// Read raw bytes that are actually encoded (but we'll ignore that)
				fis = new java.io.FileInputStream("test2.gif.b64_out2");
				...
				javax.swing.JScrollPane jsp = new javax.swing.JScrollPane(jta);
				javax.swing.JFrame jframe = new javax.swing.JFrame();
				jframe.setTitle("Read from test2.gif.b64_out2");
				jframe.getContentPane().add(jsp);
				jframe.pack();
				jframe.show();

				// Write encoded bytes to decoded raw file
				fos = new java.io.FileOutputStream("test2.gif_out2");
				b64os = new OutputStream(fos, DECODE);
				b64os.write(rebytes);
				b64os.close();
				javax.swing.ImageIcon iicon = new javax.swing.ImageIcon("test2.gif_out2");
				javax.swing.JLabel jlabel = new javax.swing.JLabel("Read from test2.gif_out2", iicon, 0);
				jframe = new javax.swing.JFrame();
				jframe.getContentPane().add(jlabel);
				jframe.pack();
				jframe.show();
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
	...
	/**
	 * A {@link net.iharder.Base64.InputStream} will read data from another
	 * {@link java.io.InputStream}, given in the constructor,
	 * and encode/decode to/from Base64 notation on the fly.
	 *
	 * @see net.iharder.Base64
	...
	public static class InputStream extends java.io.FilterInputStream
	{
		...
		/**
		 * Constructs a {@link net.iharder.Base64.InputStream} in DECODE mode.
		 *
		...
		/**
		 * Constructs a {@link net.iharder.Base64.InputStream} in
		 * either ENCODE or DECODE mode.
		 *
		 * @param in the {@link java.io.InputStream} from which to read data.
		 * @param encode Conversion direction
		 * @see net.iharder.Base64#ENCODE
		 * @see net.iharder.Base64#DECODE
		 * @since 1.3
		 */
	...
	/**
	 * A {@link net.iharder.Base64.OutputStream} will write data to another
	...
	public static class OutputStream extends java.io.FilterOutputStream
	{
		...
		/**
		 * Constructs a {@link net.iharder.Base64#OutputStream} in ENCODE mode.
		 *
		...
		/**
		 * Constructs a {@link net.iharder.Base64#OutputStream} in
		 * either ENCODE or DECODE mode.
		 *
		 * @param out the {@link java.io.OutputStream} to which data will be written.
		 * @param encode Conversion direction
