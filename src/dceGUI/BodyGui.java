 ...
 */
public class BodyGui extends JPanel implements ActionListener
{
    ...
    private static final int BODY_SEAL_INDEX = 0;
    ...
    public BodyGui(ModelInterfaceBase iface) {
        this();
        setInterface(iface);
    }
	...
	private JPanel makeRadioPanel()
	{
		...
		JComponent[] comps = {inputLabel, bodySeal, resultLabel,
	...
	public void dispose()
	{
		SwingUtilities.windowForComponent(BodyGui.this).dispose();
	}
	...
	public static void main(String[] args)
	{
		...
		f.getContentPane().add(new BodyGui());
