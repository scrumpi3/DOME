 ...
 */
public class CutLineGui extends JPanel implements ActionListener
{
	public static final GridBagConstraints gbc = null;

    private static final String CUT_LINE_CARD = "cutLine";
    private static final String STANDARD_CARD = "standardResults";
    private static final String TEARDOWN_CARD = "tearDownResults";

    private static final int CUT_LINE_INDEX = 0;
    ...
    public CutLineGui(ModelInterfaceBase iface) {
        this();
        setInterface(iface);
    }
	...
	private JPanel makeRadioPanel()
	{
		...
		JComponent[] comps = {inputLabel, cutLineSeal, resultLabel,
	...
	public void dispose()
	{
		SwingUtilities.windowForComponent(CutLineGui.this).dispose();
	}
	...
	public static void main(String[] args)
	{
		...
		f.getContentPane().add(new CutLineGui());
