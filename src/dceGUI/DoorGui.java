 ...
 */
public class DoorGui extends JPanel implements ActionListener
{
    ...
    private static final int DOOR_SEAL_INDEX = 0;
    ...
    public DoorGui(ModelInterfaceBase iface) {
        this();
        setInterface(iface);
    }
	/**
	...
	private JPanel makeRadioPanel()
	{
		...
		JComponent[] comps = {inputLabel, doorSeal, resultLabel,
	...
	public void dispose()
	{
		SwingUtilities.windowForComponent(DoorGui.this).dispose();
	}
	...
	public static void main(String[] args)
	{
		...
		f.getContentPane().add(new DoorGui());
