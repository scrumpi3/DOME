...
public class ProgramGui extends JPanel implements ActionListener
{
    ...
    public ProgramGui(ModelInterfaceBase iface) {
        this();
        setInterface(iface);
    }
	...
	private JPanel makeRadioPanel()
	{
		...
		JComponent[] comps = {inputLabel, programGeometry, resultLabel,
	...
	public void dispose()
	{
		SwingUtilities.windowForComponent(ProgramGui.this).dispose();
	}
	...
	public static void main(String[] args)
	{
		...
		f.getContentPane().add(new ProgramGui());
