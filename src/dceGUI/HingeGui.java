 ...
 */
public class HingeGui extends JPanel implements ActionListener
{
    ...
    private static final int HINGE_INDEX = 0;
    ...
    public HingeGui(ModelInterfaceBase iface) {
        this();
        setInterface(iface);
    }
	/**
	...
	private JPanel makeRadioPanel()
	{
		...
		JComponent[] comps = {inputLabel, hinge, resultLabel,
	...
	public void dispose()
	{
		SwingUtilities.windowForComponent(HingeGui.this).dispose();
	}
	...
	public static void main(String[] args)
	{
		...
		f.getContentPane().add(new HingeGui());
