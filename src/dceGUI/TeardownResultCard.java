...
public class TeardownResultCard extends JPanel
{
    ...
    private JPanel makeTopPanel() {
        JPanel p = new JPanel();
        JLabel standardLabel = Templates.makeLabel("Teardown Results", Templates.FONT12B);
        JTextArea standardText1 = Templates.makeDTextArea("The teardown analysis is designed to determine the amount of energy that each modeled component contributes to the overall closing effort." +
        "The total energy required for a fully assembled door is used as a baseline reference.");
        standardText1.setOpaque(false);

        ImageIcon image = Templates.makeImageIcon("dceGUI/images/teardown.gif");
    ...
    public void setInterface(ModelInterfaceBase iface) {
        ...
        //todo need to hook up the others[]
